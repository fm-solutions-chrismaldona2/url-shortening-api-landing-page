...
export const BgShortenPattern = ({ fill = "#4b3f6b", className, ...props }) => {
  return (
    <>
      <svg
        ...
        width={237}
        height={128}
        className={cn(styles["shorten-pattern--mobile"], className)}
        {...props}
      >
        <path
          fill={fill}
      ...
      <svg
        ...
        className={cn(styles["shorten-pattern--desktop"], className)}
        {...props}
      >
        <path
          fill={fill}
...
BgShortenPattern.propTypes = {
  fill: PropTypes.string,
  className: PropTypes.string,
};

export const BgBoostPattern = ({ fill = "#4b3f6b", className, ...props }) => {
  return (
    <>
      <svg
        xmlns="http://www.w3.org/2000/svg"
        ...
        height="300"
        viewBox="0 0 375 300"
        className={cn(styles["boost-pattern--mobile"], className)}
        {...props}
      >
      ...
      <svg
        ...
        className={cn(styles["boost-pattern--desktop"], className)}
        {...props}
      >
        <g fill={fill} fillRule="evenodd">
